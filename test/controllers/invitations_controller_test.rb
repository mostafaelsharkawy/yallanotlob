...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { join: @invitation.join, order_id: @invitation.order_id, user_id: @invitation.user_id }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { join: @invitation.join, order_id: @invitation.order_id, user_id: @invitation.user_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
