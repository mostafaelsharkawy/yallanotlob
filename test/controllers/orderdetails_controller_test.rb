...
class OrderdetailsControllerTest < ActionController::TestCase
  ...
  test "should create orderdetail" do
    assert_difference('Orderdetail.count') do
      post :create, orderdetail: { amount: @orderdetail.amount, comment: @orderdetail.comment, item: @orderdetail.item, order_id: @orderdetail.order_id, price: @orderdetail.price, user_id: @orderdetail.user_id }
    end
  ...
  test "should update orderdetail" do
    patch :update, id: @orderdetail, orderdetail: { amount: @orderdetail.amount, comment: @orderdetail.comment, item: @orderdetail.item, order_id: @orderdetail.order_id, price: @orderdetail.price, user_id: @orderdetail.user_id }
    assert_redirected_to orderdetail_path(assigns(:orderdetail))
  end
